...
.. note:: This is the documentation for the latest version (master branch) of Franka ROS Interface. For proper documentation of methods in other versions, see documentations (docstring) in the source code files of the corresponding version.
