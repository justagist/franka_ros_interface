...
#include <franka_control_ros/cartesian_impedance_controller.h>
...
bool CartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<franka_control_ros::compliance_paramConfig>>(
...
void CartesianImpedanceController::complianceParamCallback(
    franka_control_ros::compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_control_ros::CartesianImpedanceController,
